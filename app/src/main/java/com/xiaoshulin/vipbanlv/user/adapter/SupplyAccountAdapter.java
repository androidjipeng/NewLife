 ...
 * @date 2018/9/29
 */
public class SupplyAccountAdapter extends RecyclerView.Adapter<SupplyAccountAdapter.ViewHolder> {
    private Context context;
    private List<SupplyAccountBean.ListBean> list;

    public SupplyAccountAdapter(Context context, List<SupplyAccountBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.try_num.setText("共" + list.get(position).getNeeds()+ "人需要账号");
