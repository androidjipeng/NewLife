 ...
 * @date 2018/9/28
 */
public class VLevelAdapter extends RecyclerView.Adapter<VLevelAdapter.ViewHolder> {
    private Context context;
    private List<VLevelBean.ListBean> list;

    public VLevelAdapter(Context context, List<VLevelBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tv_value.setText(list.get(position).getV()+"V");
