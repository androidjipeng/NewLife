 ...
 * 我的
 */
public class CircleFragment5 extends BaseMVPFragment implements IAllCircleView,View.OnClickListener {
    ...
    public CircleFragment5() {
        // Required empty public constructor
    }

    public static CircleFragment5 newInstance() {
    ...
    protected void initView() {
        ...
        adapter=new CircleAdapter1(getContext(),list,5);
