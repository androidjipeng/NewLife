 ...
 * 订单
 */
public class CircleFragment4 extends BaseMVPFragment implements IAllCircleView,View.OnClickListener {
    ...
    public CircleFragment4() {
        // Required empty public constructor
    }
    public static CircleFragment4 newInstance() {
        CircleFragment4 fragment = new CircleFragment4();
        return fragment;
    }
    ...
    protected void initView() {
        ...
        adapter=new CircleAdapter1(getContext(),list,4);
...
//                    presenter.BuyPro(Circleid,"1");
    ...
    public void getV_money(CheckVisionBean checkVisionBean) {
        ...
        tv_payWeixin.setVisibility(View.GONE);

        String str = "商品担保期还有：<font color='#FF0000'>" + days+ "天" + "</font>";
        tv_pay1.setText(Html.fromHtml(str));

        tv_pay2.setText("查看订单");
