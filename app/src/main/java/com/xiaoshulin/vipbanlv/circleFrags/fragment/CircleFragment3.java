 ...
 * 收藏
 */
public class CircleFragment3 extends BaseMVPFragment implements IAllCircleView,View.OnClickListener {
    ...
    public CircleFragment3() {
        // Required empty public constructor
    }
    public static CircleFragment3 newInstance() {
        CircleFragment3 fragment = new CircleFragment3();
        return fragment;
    }
    ...
    protected void initView() {
        ...
        adapter=new CircleAdapter1(getContext(),list,3);
