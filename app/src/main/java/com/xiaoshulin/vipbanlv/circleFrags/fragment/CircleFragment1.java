 ...
 * 最新
 */
public class CircleFragment1 extends BaseMVPFragment implements IAllCircleView, View.OnClickListener {
    ...
    public CircleFragment1() {
        // Required empty public constructor
    }

    public static CircleFragment1 newInstance() {
        CircleFragment1 fragment = new CircleFragment1();
        return fragment;
    }
    ...
    protected void initView() {
        ...
        stringUId = SharePreferenceUtil.getinstance().getStringUId();
